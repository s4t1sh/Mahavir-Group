...
<?php
  $card1 = (object) [
    'img' => '../../assets/media/Amenties/spa.png',
    'title' => 'Spa Centers',
  ...
  $card2 = (object) [
    'img' => '../../assets/media/Amenties/school.png',
    'title' => 'Schools',
    'desc' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum '
  ];
  
  $card3 = (object) [
    'img' => '../../assets/media/Amenties/playground.png',
    'title' => 'Playground',
    'desc' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum '
  ];
  
  $myAmenities = [$card1, $card2, $card3];

?>

<?php
  $img = "../../assets/media/dtc/logo.webp";
  $amenities = array("Internal Roads","Water Supply Line","Sewerage system","Storm Water Drains","Landscaping & Tree Planting","Street Lighting","Community building and club house","Rain water harvesting","Open area (Park)","Boundary Wall","Children’s play area","Pump house/overhead tank");
?>
