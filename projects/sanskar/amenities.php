...
// $card = (object) [
  ...
  $img = "../../assets/media/Amenties/garden.webp";
  
  $amenities = array("Grand & Designer Entrance gate with guard room","40 feet wide entrance open lobby with landscaping","Secured campus with boundary wall","Street lights","Efficient drainage system","Big & beautiful landscape garden","Temple","Club House","Jogging track");
