...
// $card = (object) [
  ...
  $img = "../../assets/media/Amenties/aRiddhi-Siddhi-K.webp";
  
  $amenities = array("Internal Roads","Water Supply Line","Sewerage system","Storm Water Drains","Landscaping & Tree Planting","Street Lighting","Water Conservation","Open area (Park)","Boundary Wall");
