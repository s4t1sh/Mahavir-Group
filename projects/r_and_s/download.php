...
<div class="container-fluid project-nav  bg-black">
      <div class="row ps-5  pt-3 pb-3 d-none d-md-flex">
        ...
        <div class="col-1"><a href=<?php echo $download; ?> style='color:#C9C281'>Download</a></div>
      ...
      <div class="row pt-3 pb-3 d-sm-flex d-md-none fw-bold" style='font-size: 11px;'>
        ...
        <div class="col"><a href=<?php echo $download; ?> style='color:#C9C281'>Download</a></div>
...
<?php 
$download_desc ="Our latest projects across india";
?>

<?php include '../download/download.php'; ?>

<?php include '../overview/new_at_glance.php'; ?>
